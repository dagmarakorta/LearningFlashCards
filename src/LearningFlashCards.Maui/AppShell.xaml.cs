...
namespace LearningFlashCards.Maui
{
    public partial class AppShell : Shell
    {
        public AppShell()
        {
            ...
            Routing.RegisterRoute(nameof(StudyDeckPage), typeof(StudyDeckPage));
            ...
            Routing.RegisterRoute(nameof(ImportCardsPage), typeof(ImportCardsPage));
            Routing.RegisterRoute(nameof(BrowseDecksPage), typeof(BrowseDecksPage));
        }
